				...
				<div class="main-wrap">
					<div class="user-info">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">删除商品</strong> </div>
						</div>
						
						<script type="text/javascript">
							function validate() {
								id = document.b.id.value;
						...
						<div class="login-form">
						  <form action ="shangpinServlet" mothod = "post"  name="b">
							   <input type="hidden" name="method" value="delete">
							  		编号：<input type="text" name="id" >
							 		<br><input type="submit" onclick="validate()">
              			  </form>
         			    </div>
