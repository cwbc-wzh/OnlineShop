				...
				<div class="main-wrap">
					<div class="user-info">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">更新商品</strong> </div>
						</div>
						...
						<script type="text/javascript">
							function validate() {
								...
								name = document.a.name.value;
								price = document.a.price.value;
								date = document.a.date.value;
								salesnum = document.a.salesnum.value;
								storenum = document.a.storenum.value;
								kind = document.a.kind.value;
								if(id==""){
									alert("商品名不能为空");
									...
									alert("价格不能为空");
									document.a.date.focus();
									return;
								} else if(salesnum==""){
									alert("销售数不能为空");
									document.a.salesnum.focus();
									return;
								} else if(storenum==""){
									alert("库存不能为空");
									document.a.storenum.focus();
									return;
								} else if(kind==""){
									alert("种类不能为空");
									document.a.kind.focus();
									return;
								}
								document.a.submit();
							}
						  ...
						  <form action ="shangpinServlet" mothod = "post" name = "a">
							   <input type="hidden" name="method" value="update">
								  ...
								  <table>
								  	...
								  	<li>
								  		<ui>名称：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ui>
								  		<ui><input type="text" name="name" ></ui>
								  	</li>
								  	<li>
								  		<ui>价格：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ui>
								  		<ui><input type="text" name="price" ></ui>
								  	</li>
								  	<li>
								  		<ui>上架时间：</ui>
								  		<ui><input type="text" name="date" ></ui>
								  	</li>
								  	<li>
								  		<ui>售出：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ui>
								  		<ui><input type="text" name="salesnum" ></ui>
								  	</li>
								  	<li>
								  		<ui>库存：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ui>
								  		<ui><input type="text" name="storenum" ></ui>
								  	</li>
								  	<li>
								  		<ui>类别：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</ui>
								  		<ui><input type="text" name="kind" ></ui>
								  	</li>
