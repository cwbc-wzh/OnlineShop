				...
				<div class="main-wrap">
					<div class="user-info">
						...
						<div class="am-cf am-padding">
							<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">添加商品图片</strong> </div>
						</div>
						<div class="login-form">
						  ...
						  <form action="fileUpload" method="post" enctype="multipart/form-data" name="a">
							
							  	
								  	编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								  	<input type="text" name="name" ><br>

								  	选择图片：<input type="file" name="pic"/>
