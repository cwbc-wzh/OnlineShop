...
import com.atwzh.store.dao.Dao;
import com.atwzh.store.db.JDBCUtils;
import com.atwzh.store.utils.ReflectionUtils;
import com.atwzh.store.web.ConnectionContext;
...
public class BaseDAO<T> implements Dao<T> {
	...
	public void update2(String id, String path) {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		String sql = null;
		try {
			connection = ConnectionContext.getInstance().get();
			sql = "UPDATE shangpin set Author = ? WHERE id = ?";
